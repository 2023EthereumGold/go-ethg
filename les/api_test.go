...
import (
	...
	"github.com/ethg/go-ethg/p2p/simulations"
	"github.com/ethg/go-ethg/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	ethg, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, ethg, &config)
	if err != nil {
		return nil, err
	}
	return ethg, nil

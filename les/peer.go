...
import (
	...
	lps "github.com/ethg/go-ethg/les/lespay/server"
	"github.com/ethg/go-ethg/les/utils"
	"github.com/ethg/go-ethg/light"
	"github.com/ethg/go-ethg/p2p"
	"github.com/ethg/go-ethg/params"
	"github.com/ethg/go-ethg/rlp"
)
	...
	return p.handshake(td, head, headNum, genesis, func(lists *keyValueList) {
		...
		if !server.config.UltraLightOnlyAnnounce {
			...
			*lists = (*lists).add("serveStateSince", uint64(0))
			...
			// If local ethg node is running in archive mode, advertise ourselves we have

// Copyright 2017 The go-ethg Authors
...
type wallet struct {
	...
	deriveChain     ethg.ChainStateReader // Blockchain state reader to discover used account with
...
// chain state reader.
func (w *wallet) SelfDerive(bases []accounts.DerivationPath, chain ethg.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()

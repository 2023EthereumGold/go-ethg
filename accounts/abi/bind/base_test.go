...
func (mc *mockCaller) CallContract(ctx context.Context, call ethg.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call ethg.CallMsg) ([]byte, error) {

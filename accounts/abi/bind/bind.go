...
//
// Detailed usage document and tutorial available on the go-ethg Wiki page:
// https://github.com/ethg/go-ethg/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
